function [modulation, originalModulation, isSignificant, psd_features] = ...
          getModIndexWithRefPer(spikeTrain, refPeriod, fs,...
                                band, winLen, numSTDs)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    psd_features.psd        = spectrum;
    psd_features.frequency  = freqRange;
    psd_features.snr        = snr;
    psd_features.peak_power = peakPower;
    psd_features.peak_freq  = peakFreq;
    freq                    = ceil((startBand + endBand)/2);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
